...
public class ImageServlet extends HttpServlet {
    ...
    //private final String UPLOAD_DIR = ResourceBundle.getBundle("/Bundle").getString("UPLOAD_LOCATION");
    ...
    protected void doGet(
        ...
        if ((p == null) || (p.getImgSrc() == null)) {
            ...
            response.setHeader(
                    "Content-Length",
                    String.valueOf(p.getImgSrc().length));
            response.setHeader(
                    "Content-Disposition",
    ...
    private static void close(Closeable resource) {
        if (resource != null) {
            try {
                ...
                logger.severe(
                        "Problems during image resource manipulation. "
                        + e.getMessage());
            }
        }
    }
